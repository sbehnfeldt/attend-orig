 ...
 *
 * @method     ChildClassroom findOne(ConnectionInterface $con = null) Return the first ChildClassroom matching the query
 ...
 *
 * @method     ChildClassroom findOneById(int $id) Return the first ChildClassroom filtered by the id column
 * @method     ChildClassroom findOneByLabel(string $label) Return the first ChildClassroom filtered by the label column
 * @method     ChildClassroom findOneByOrdering(int $ordering) Return the first ChildClassroom filtered by the ordering column
 * @method     ChildClassroom findOneByCreatedAt(string $created_at) Return the first ChildClassroom filtered by the created_at column
 * @method     ChildClassroom findOneByUpdatedAt(string $updated_at) Return the first ChildClassroom filtered by the updated_at column *
 ...
 *
 * @method     ChildClassroom[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildClassroom objects based on current ModelCriteria
 * @method     ChildClassroom[]|ObjectCollection findById(int $id) Return ChildClassroom objects filtered by the id column
 * @method     ChildClassroom[]|ObjectCollection findByLabel(string $label) Return ChildClassroom objects filtered by the label column
 * @method     ChildClassroom[]|ObjectCollection findByOrdering(int $ordering) Return ChildClassroom objects filtered by the ordering column
 * @method     ChildClassroom[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildClassroom objects filtered by the created_at column
 * @method     ChildClassroom[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildClassroom objects filtered by the updated_at column
...
abstract class ClassroomQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Attend\Database\Base\ClassroomQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'attend', $modelName = '\\Attend\\Database\\Classroom', $modelAlias = null)
    {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildClassroomQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(ClassroomTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ClassroomTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClassroomTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByLabel($label = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClassroomTableMap::COL_LABEL, $label, $comparison);
    }
    ...
    public function filterByOrdering($ordering = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClassroomTableMap::COL_ORDERING, $ordering, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClassroomTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClassroomTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }

    /**
     * Filter the query by a related \Attend\Database\Student object
     *
     * @param \Attend\Database\Student|ObjectCollection $student the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildClassroomQuery The current query, for fluid interface
     */
