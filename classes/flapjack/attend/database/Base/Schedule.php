...
abstract class Schedule implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\flapjack\\attend\\database\\Map\\ScheduleTableMap';
     ...
     * objects.
     *
     * @param object $copyObj An object of \flapjack\attend\database\Schedule (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \flapjack\attend\database\Schedule Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
